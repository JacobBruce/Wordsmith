...
{
public:
	wsTextCtrl(wxWindow* parent, wxWindowID id=wxID_ANY,
...
namespace GLOBALS {
	...
	inline bool ManualAutoComp = false;
...
class WordsmithFrame: public wxFrame
{
	...
	private:
		...
		bool searchMode = 0;
		bool inAutoCompUpdate = false;
		bool suppressAutoComp = false;
		bool inSpellCheck = false;
		...
		void UpdateTabSaveState(wsTextCtrl* stc, bool changed);
		void BindTextCtrl(wsTextCtrl* stc);
		void ShowFontDialog();
		void ShowPrintDialog(bool preview=false);
		void ShowPageDialog();
		void ShowOpenDialog();
		bool ShowSaveDialog(bool force_show=false);
		void ShowFindDialog();
		...
		void OnReloadClick(wxCommandEvent& event);
		...
		void OnCaseClick(wxCommandEvent& event);
		...
		static const wxWindowID ID_MENUITEM57;
		...
		static const wxWindowID ID_MENUITEM53;
		static const wxWindowID ID_MENUITEM54;
		static const wxWindowID ID_MENUITEM55;
		static const wxWindowID ID_MENUITEM56;
		static const wxWindowID ID_MENUITEM58;
